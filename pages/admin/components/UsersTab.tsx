    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
        ...
        <Button
          ...
          onClick={() => setOpenPromoteConfirm(true)}
        >
          Promote All
        </Button>
      </Box>
            ...
            <ListItemText
              ...
              secondary={
                <Box component="span" sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 0.5 }}>
                  ...
                  {user.classYear && (
                    <Chip label={`Yr ${user.classYear}`} size="small" variant="outlined" />
                  )}
                  {user.flight && (
                    <Chip label={user.flight} size="small" color="primary" variant="outlined" />
                  )}
                  <Chip
                    label={jobTitle(user.jobId)}
                    size="small"
                    color="secondary"
                    variant="outlined"
                  />
      ...
      <Dialog open={openPromoteConfirm} onClose={() => setOpenPromoteConfirm(false)}>
        ...
        <DialogContent>
          <Typography>
            This will advance every cadet's class year and rank. Cadets at year 400 will move to
            'special' — you'll be asked what to do with them after.
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setOpenPromoteConfirm(false)}>Cancle</Button>
          <Button onClick={handlePromote} color="warning" variant="contained">
            Promote
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={openGradDialog} onClose={() => {}} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          <Button onClick={handleGradFinalize} variant="contained">
            Confirm
          </Button>
        </DialogActions>
      </Dialog>
