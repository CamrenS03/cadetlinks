...
export default function Home() {
  ...
  const canManageAnnouncements =
    cachedJob?.permissions?.some((p) => ['manage_announcements', 'admin'].includes(p)) ?? false;
      ...
      >
        ...
        >
          ...
          {canManageAnnouncements && (
            <IconButton aria-label="add" onClick={() => setOpenAddModal(true)} color="secondary">
              <Add />
            </IconButton>
          )}
        </Box>
                    ...
                    <Box sx={{ flex: 1 }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        {announcement.importance !== 'low' && (
                          <Chip
                            label={
                              announcement.importance.charAt(0).toUpperCase() +
                              announcement.importance.slice(1)
                            }
